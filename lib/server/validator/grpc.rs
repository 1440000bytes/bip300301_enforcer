...
use crate::{
    ...
    proto::{
        ...
        mainchain::{
            GetBlockHeaderInfoResponse, GetBlockInfoResponse, GetBmmHStarCommitmentResponse,
            GetChainInfoResponse, GetChainTipResponse, GetCoinbasePSBTResponse, GetCtipResponse,
            GetSidechainProposalsResponse, GetSidechainsResponse, GetTwoWayPegDataResponse,
            Network, StopResponse, SubscribeEventsResponse, SubscribeHeaderSyncProgressResponse,
        ...
        mainchain_service::{
            OwnedGetBlockHeaderInfoRequestView, OwnedGetBlockInfoRequestView,
            OwnedGetBmmHStarCommitmentRequestView, OwnedGetChainInfoRequestView,
            OwnedGetChainTipRequestView, OwnedGetCoinbasePsbtRequestView, OwnedGetCtipRequestView,
            OwnedGetSidechainProposalsRequestView, OwnedGetSidechainsRequestView,
            OwnedGetTwoWayPegDataRequestView, OwnedStopRequestView,
            OwnedSubscribeEventsRequestView, OwnedSubscribeHeaderSyncProgressRequestView,
            ValidatorService,
        },
        wrap_u32,
    },
...
impl ValidatorService for Server {
    async fn get_block_header_info(
        &self,
        _ctx: RequestContext,
        request: OwnedGetBlockHeaderInfoRequestView,
    ...
    async fn get_block_info(
        &self,
        _ctx: RequestContext,
        request: OwnedGetBlockInfoRequestView,
    ...
    async fn get_bmm_h_star_commitment(
        &self,
        _ctx: RequestContext,
        request: OwnedGetBmmHStarCommitmentRequestView,
    ...
    async fn get_chain_info(
        &self,
        _ctx: RequestContext,
        _request: OwnedGetChainInfoRequestView,
    ...
    async fn get_chain_tip(
        &self,
        _ctx: RequestContext,
        _request: OwnedGetChainTipRequestView,
    ...
    async fn get_ctip(
        &self,
        _ctx: RequestContext,
        request: OwnedGetCtipRequestView,
    ...
    async fn get_sidechain_proposals(
        &self,
        _ctx: RequestContext,
        _request: OwnedGetSidechainProposalsRequestView,
    ...
    async fn get_sidechains(
        &self,
        _ctx: RequestContext,
        _request: OwnedGetSidechainsRequestView,
    ...
    async fn get_two_way_peg_data(
        &self,
        _ctx: RequestContext,
        request: OwnedGetTwoWayPegDataRequestView,
    ...
    async fn subscribe_header_sync_progress(
        &self,
        _ctx: RequestContext,
        _request: OwnedSubscribeHeaderSyncProgressRequestView,
