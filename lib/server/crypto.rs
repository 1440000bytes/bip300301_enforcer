...
use crate::{
    proto::{
        ...
        crypto_service::{
            CryptoService, OwnedHmacSha512RequestView, OwnedRipemd160RequestView,
            OwnedSecp256k1SecretKeyToPublicKeyRequestView, OwnedSecp256k1SignRequestView,
            OwnedSecp256k1VerifyRequestView,
        },
    },
...
impl CryptoService for CryptoServiceServer {
    async fn ripemd160(
        &self,
        _ctx: RequestContext,
        request: OwnedRipemd160RequestView,
    ...
    async fn hmac_sha512(
        &self,
        _ctx: RequestContext,
        request: OwnedHmacSha512RequestView,
    ...
    async fn secp256k1_sign(
        &self,
        _ctx: RequestContext,
        request: OwnedSecp256k1SignRequestView,
    ...
    async fn secp256k1_verify(
        &self,
        _ctx: RequestContext,
        request: OwnedSecp256k1VerifyRequestView,
