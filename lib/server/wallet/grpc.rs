...
use crate::{
    ...
    proto::{
        ...
        common::ReverseHex,
        mainchain::{
            BroadcastWithdrawalBundleResponse, CreateBmmCriticalDataTransactionResponse,
            CreateDepositTransactionResponse, CreateNewAddressResponse,
            CreateSidechainProposalResponse, CreateWalletResponse, GenerateBlocksResponse,
            GetBalanceResponse, GetInfoResponse, ListSidechainDepositTransactionsResponse,
            ListTransactionsResponse, ListUnspentOutputsResponse, SendTransactionResponse,
        ...
        mainchain_service::{
            ...
            OwnedCreateBmmCriticalDataTransactionRequestView,
            OwnedCreateDepositTransactionRequestView, OwnedCreateNewAddressRequestView,
            OwnedCreateSidechainProposalRequestView, OwnedCreateWalletRequestView,
            OwnedGenerateBlocksRequestView, OwnedGetBalanceRequestView, OwnedGetInfoRequestView,
            OwnedListSidechainDepositTransactionsRequestView, OwnedListTransactionsRequestView,
            OwnedListUnspentOutputsRequestView, OwnedSendTransactionRequestView,
            OwnedUnlockWalletRequestView, WalletService,
        },
...
impl WalletService for crate::wallet::Wallet {
    async fn get_info(
        &self,
        _ctx: RequestContext,
        _request: OwnedGetInfoRequestView,
    ...
    async fn create_sidechain_proposal(
        &self,
        _ctx: RequestContext,
        request: OwnedCreateSidechainProposalRequestView,
        ...
        let sidechain_id =
            parse_sidechain_id::<CreateSidechainProposalRequest>(sidechain_id, "sidechain_id")?;
        ...
        self.propose_sidechain(&sidechain_proposal)
            .await
            .map_err(|err| {
    ...
    async fn create_new_address(
        &self,
        _ctx: RequestContext,
        _request: OwnedCreateNewAddressRequestView,
    ...
    async fn generate_blocks(
        &self,
        _ctx: RequestContext,
        request: OwnedGenerateBlocksRequestView,
    ...
    async fn broadcast_withdrawal_bundle(
        &self,
        _ctx: RequestContext,
        request: OwnedBroadcastWithdrawalBundleRequestView,
    ...
    async fn create_bmm_critical_data_transaction(
        &self,
        _ctx: RequestContext,
        request: OwnedCreateBmmCriticalDataTransactionRequestView,
    ...
    async fn create_deposit_transaction(
        &self,
        _ctx: RequestContext,
        request: OwnedCreateDepositTransactionRequestView,
    ...
    async fn get_balance(
        &self,
        _ctx: RequestContext,
        _request: OwnedGetBalanceRequestView,
    ...
    async fn list_unspent_outputs(
        &self,
        _ctx: RequestContext,
        _request: OwnedListUnspentOutputsRequestView,
    ...
    async fn list_sidechain_deposit_transactions(
        &self,
        _ctx: RequestContext,
        _request: OwnedListSidechainDepositTransactionsRequestView,
    ...
    async fn list_transactions(
        &self,
        _ctx: RequestContext,
        _request: OwnedListTransactionsRequestView,
    ...
    async fn unlock_wallet(
        &self,
        _ctx: RequestContext,
        request: OwnedUnlockWalletRequestView,
    ...
    async fn create_wallet(
        &self,
        _ctx: RequestContext,
        request: OwnedCreateWalletRequestView,
